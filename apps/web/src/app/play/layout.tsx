...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex">
      ...
      >
        {/* Logo */}
        <div className={`h-16 flex items-center border-b border-[#222] ${isSidebarOpen ? 'px-4' : 'px-3 justify-center'}`}>
            ...
            return (
              ...
              >
                <div className="relative">
                  <item.icon className={`w-5 h-5 flex-shrink-0 ${active ? 'text-white' : 'text-white/30 group-hover:text-white/60'}`} />
                  {item.badge === 'LIVE' && (
        ...
        <div className="border-t border-[#222] p-3 space-y-1">
          ...
          <div className="relative mt-2">
            ...
            >
              ...
              {isSidebarOpen && (
                <ChevronRight className={`w-4 h-4 text-white/20 transition-transform ${isProfileOpen ? 'rotate-90' : ''}`} />
              )}
            </button>
